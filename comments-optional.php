  ...
  <div id="commentsformheader">
	...
	<?php else : ?>
		...
		<div id="commentsform">
			...
			<h4>Optional:</h4>
			<p>
					<label title="Optional" for="author" class="commentlabel"><strong>Name</strong></label>
          <input title="Optional" type="text" name="author" id="author" class="commentText" value="<?php echo $comment_author; ?>" size="22" tabindex="1" />
				</p>
				<p>
					<label title="Optional, never published, useful if you have a Gravatar" for="email" class="commentlabel"><strong>E-Mail</strong></label>
          <input title="Optional, never published, useful if you have a Gravatar" type="text" name="email" id="email" class="commentText" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" />
				</p>
				<p>
					<label for="url" class="commentlabel"><strong>URL</strong></label>
          <input title="Optional" type="text" name="url" id="url" class="commentText" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" />
				</p>
